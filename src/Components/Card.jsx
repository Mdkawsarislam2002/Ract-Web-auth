...
const Card = () => {
  return (
    <>
      <div className="dark:bg-gray-800 w-full max-w-sm px-4 py-3 mx-auto bg-white rounded-md shadow-md">
        <div className="flex items-center justify-between">
          <span className="dark:text-gray-400 text-sm font-light text-gray-800">
            Courses and MOOCs
          </span>
          <span className="dark:bg-blue-300 dark:text-blue-900 px-3 py-1 text-xs text-blue-800 uppercase bg-blue-200 rounded-full">
            psychology
          </span>
        </div>

        <div>
          <h1 className="dark:text-white mt-2 text-lg font-semibold text-gray-800">
            AP® Psychology - Course 5: Health and Behavior
          </h1>
          <p className="dark:text-gray-300 mt-2 text-sm text-gray-600">
        ...
        <div>
          <div className="dark:text-gray-200 flex items-center mt-2 text-gray-700">
            <span>Visit on:</span>
            <a className="dark:text-blue-400 hover:underline mx-2 text-blue-600 cursor-pointer">
              edx.org
            </a>
            <span>or</span>
            <a className="dark:text-blue-400 hover:underline mx-2 text-blue-600 cursor-pointer">
          ...
          <div className="flex items-center justify-center mt-4">
            <a className="dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 mr-2 text-gray-800 cursor-pointer">
              <svg
