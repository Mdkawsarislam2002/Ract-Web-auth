...
import dopSvg from "./svg components/dopSvg";
const SingIn = () => {
  return (
    <>
            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <form>
                  ...
                  <div className="mb-10">
                    <input
                      type="submit"
                      value="Sign In"
                      className=" border-primary bg-primary text-slate-800 hover:bg-opacity-90 w-full px-5 py-3 text-base transition border rounded-md cursor-pointer"
                    />
                  </div>
                </form>
                ...
                <div>
                  ...
                  <span className="left-1 bottom-1 absolute">
                    <dopSvg />
                  </span>
                </div>
              </div>
