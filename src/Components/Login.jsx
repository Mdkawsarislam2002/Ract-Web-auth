...
const Login = () => {
  return (
    <>
      <div className="dark:bg-gray-800 w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md">
        ...
        <form className="mt-6">
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between">
              ...
              <a
                href="#"
                className="dark:text-gray-400 hover:underline text-xs text-gray-600"
              >
                Forget Password?
              </a>
            </div>
          ...
          <div className="mt-6">
            <button className="hover:bg-gray-600 focus:outline-none focus:bg-gray-600 w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-gray-700 rounded-md">
              Login
            </button>
          </div>
        </form>
        ...
        <div className="flex items-center mt-6 -mx-2">
          ...
          >
            ...
            <span className="sm:inline hidden mx-2">Sign in with Google</span>
          </button>
        ...
        <p className="mt-8 text-xs font-light text-center text-gray-400">
          ...
          <a
            href="#"
            className="dark:text-gray-200 hover:underline font-medium text-gray-700"
          >
            Create One
          </a>
        </p>
